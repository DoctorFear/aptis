...
BASE_URL = "https://aptiskey.com/api/writingkey-data/{id}"
OUT_DIR = "writingkey_data"
...
for i in range(1, TOTAL_IDS + 1):
    ...
    out_path = os.path.join(OUT_DIR, f"writingkey_{i}.json")
...
combined_path = os.path.join(OUT_DIR, "writingkey_all.json")
